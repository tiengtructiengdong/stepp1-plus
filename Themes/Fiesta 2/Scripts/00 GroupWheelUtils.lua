...
local SortsSounds = {
	...
	{"SO_LEVEL_1",  "22_LEVEL4.MP3"};
	{"SO_LEVEL_2",  "23_LEVEL5.MP3"};
	{"SO_LEVEL_3",  "24_LEVEL6.MP3"};
	{"SO_LEVEL_4",  "25_LEVEL7.MP3"};
	{"SO_LEVEL_5",  "26_LEVEL8.MP3"};
	{"SO_LEVEL_6",  "27_LEVEL9.MP3"};
	{"SO_LEVEL_7",  "28_LEVEL10.MP3"};
	{"SO_LEVEL_8",  "29_LEVEL11.MP3"};
	{"SO_LEVEL_9",  "30_LEVEL12.MP3"};
	{"SO_LEVEL_10", "31_LEVEL13.MP3"};
	{"SO_LEVEL_11", "32_LEVEL14.MP3"};
	{"SO_LEVEL_12", "33_LEVEL15.MP3"};
	{"SO_LEVEL_13", "34_LEVEL16.MP3"};
	{"SO_LEVEL_14", "35_LEVEL17.MP3"};
	{"SO_LEVEL_15", "36_LEVEL18.MP3"};
	{"SO_LEVEL_16", "37_LEVEL19.MP3"};
	{"SO_LEVEL_17", "38_LEVEL20.MP3"};
	{"SO_LEVEL_18", "39_LEVEL21.MP3"};
	{"SO_LEVEL_19", "40_LEVEL22.MP3"};
	{"SO_LEVEL_20", "41_LEVEL23.MP3"};
	{"SO_LEVEL_21", "42_LEVEL24OVER.MP3"};
	{"SO_LEVEL_22", "42_LEVEL24OVER.MP3"};
	{"SO_LEVEL_23", "42_LEVEL24OVER.MP3"};
...
ChannelsGraphics = {
	...
	["SO_QUEST"] = 		"C_MZ.PNG";
	["SO_COOP"] = 		"C_COOP.PNG";
	["SO_LEVEL_1"] = "C_LV_04.PNG";
	["SO_LEVEL_2"] = "C_LV_05.PNG";
	["SO_LEVEL_3"] = "C_LV_06.PNG";
	["SO_LEVEL_4"] = "C_LV_07.PNG";
	["SO_LEVEL_5"] = "C_LV_08.PNG";
	["SO_LEVEL_6"] = "C_LV_09.PNG";
	["SO_LEVEL_7"] = "C_LV_10.PNG";
	["SO_LEVEL_8"] = "C_LV_11.PNG";
	["SO_LEVEL_9"] = "C_LV_12.PNG";
	["SO_LEVEL_10"] = "C_LV_13.PNG";
	["SO_LEVEL_11"] = "C_LV_14.PNG";
	["SO_LEVEL_12"] = "C_LV_15.PNG";
	["SO_LEVEL_13"] = "C_LV_16.PNG";
	["SO_LEVEL_14"] = "C_LV_17.PNG";
	["SO_LEVEL_15"] = "C_LV_18.PNG";
	["SO_LEVEL_16"] = "C_LV_19.PNG";
	["SO_LEVEL_17"] = "C_LV_20.PNG";
	["SO_LEVEL_18"] = "C_LV_21.PNG";
	["SO_LEVEL_19"] = "C_LV_22.PNG";
	["SO_LEVEL_20"] = "C_LV_23.PNG";
	["SO_LEVEL_21"] = "C_LV_24.PNG";
	["SO_LEVEL_22"] = "C_LV_25.PNG";
	["SO_LEVEL_23"] = "C_LV_26.PNG";
	["SO_LEVEL_24"] = "C_LV_27O.PNG";
	["SO_JMUSIC"] = "C_JM.PNG";
--[[	
...
local ChannelsTextCoordSpanish = {
	...
	["SO_LEVEL_1"] =  "En este canal, puedes jugar canciones de nivel 4." ;
	["SO_LEVEL_2"] =  "En este canal, puedes jugar canciones de nivel 5." ;
	["SO_LEVEL_3"] =  "En este canal, puedes jugar canciones de nivel 6." ;
	["SO_LEVEL_4"] =  "En este canal, puedes jugar canciones de nivel 7." ;
	["SO_LEVEL_5"] =  "En este canal, puedes jugar canciones de nivel 8." ;
	["SO_LEVEL_6"] =  "En este canal, puedes jugar canciones de nivel 9." ;
	["SO_LEVEL_7"] =  "En este canal, puedes jugar canciones de nivel 10." ;
	["SO_LEVEL_8"] =  "En este canal, puedes jugar canciones de nivel 11." ;
	["SO_LEVEL_9"] =  "En este canal, puedes jugar canciones de nivel 12." ;
	["SO_LEVEL_10"] =  "En este canal, puedes jugar canciones de nivel 13." ;
	["SO_LEVEL_11"] =  "En este canal, puedes jugar canciones de nivel 14." ;
	["SO_LEVEL_12"] =  "En este canal, puedes jugar canciones de nivel 15." ;
	["SO_LEVEL_13"] =  "En este canal, puedes jugar canciones de nivel 16." ;
	["SO_LEVEL_14"] =  "En este canal, puedes jugar canciones de nivel 17." ;
	["SO_LEVEL_15"] =  "En este canal, puedes jugar canciones de nivel 18." ;
	["SO_LEVEL_16"] =  "En este canal, puedes jugar canciones de nivel 19." ;
	["SO_LEVEL_17"] =  "En este canal, puedes jugar canciones de nivel 20." ;
	["SO_LEVEL_18"] =  "En este canal, puedes jugar canciones de nivel 21." ;
	["SO_LEVEL_19"] =  "En este canal, puedes jugar canciones de nivel 22." ;
	["SO_LEVEL_20"] =  "En este canal, puedes jugar canciones de nivel 23." ;
	["SO_LEVEL_21"] =  "En este canal, puedes jugar canciones de nivel 24." ;
	["SO_LEVEL_22"] =  "En este canal, puedes jugar canciones de nivel 25." ;
	["SO_LEVEL_23"] =  "En este canal, puedes jugar canciones de nivel 26." ;
	["SO_LEVEL_24"] =  "En este canal, puedes jugar canciones de nivel 27 o m\u00e1s." ;
...
local ChannelsTextCoordEnglish = {
	...
	["SO_LEVEL_1"] =  "In this channel, you can play level 4 difficulty songs." ;
	["SO_LEVEL_2"] =  "In this channel, you can play level 5 difficulty songs." ;
	["SO_LEVEL_3"] =  "In this channel, you can play level 6 difficulty songs." ;
	["SO_LEVEL_4"] =  "In this channel, you can play level 7 difficulty songs." ;
	["SO_LEVEL_5"] =  "In this channel, you can play level 8 difficulty songs." ;
	["SO_LEVEL_6"] =  "In this channel, you can play level 9 difficulty songs." ;
	["SO_LEVEL_7"] =  "In this channel, you can play level 10 difficulty songs." ;
	["SO_LEVEL_8"] =  "In this channel, you can play level 11 difficulty songs." ;
	["SO_LEVEL_9"] =  "In this channel, you can play level 12 difficulty songs." ;
	["SO_LEVEL_10"] =  "In this channel, you can play level 13 difficulty songs." ;
	["SO_LEVEL_11"] =  "In this channel, you can play level 14 difficulty songs." ;
	["SO_LEVEL_12"] =  "In this channel, you can play level 15 difficulty songs." ;
	["SO_LEVEL_13"] =  "In this channel, you can play level 16 difficulty songs." ;
	["SO_LEVEL_14"] =  "In this channel, you can play level 17 difficulty songs." ;
	["SO_LEVEL_15"] =  "In this channel, you can play level 18 difficulty songs." ;
	["SO_LEVEL_16"] =  "In this channel, you can play level 19 difficulty songs." ;
	["SO_LEVEL_17"] =  "In this channel, you can play level 20 difficulty songs." ;
	["SO_LEVEL_18"] =  "In this channel, you can play level 21 difficulty songs." ;
	["SO_LEVEL_19"] =  "In this channel, you can play level 22 difficulty songs." ;
	["SO_LEVEL_20"] =  "In this channel, you can play level 23 difficulty songs." ;
	["SO_LEVEL_21"] =  "In this channel, you can play level 24 difficulty songs." ;
	["SO_LEVEL_22"] =  "In this channel, you can play level 25 difficulty songs." ;
	["SO_LEVEL_23"] =  "In this channel, you can play level 26 difficulty songs." ;
	["SO_LEVEL_24"] =  "In this channel, you can play songs that are level 27 difficulty or higher." ;
...
local Renames = {
	...
	["SO_LEVEL_8"] = "LEVEL 11";
	["SO_LEVEL_9"] = "LEVEL 12";
	["SO_LEVEL_10"] = "LEVEL 13";
	["SO_LEVEL_11"] = "LEVEL 14";
	["SO_LEVEL_12"] = "LEVEL 15";
	["SO_LEVEL_13"] = "LEVEL 16";
	["SO_LEVEL_14"] = "LEVEL 17";
	["SO_LEVEL_15"] = "LEVEL 18";
	["SO_LEVEL_16"] = "LEVEL 19";
	["SO_LEVEL_17"] = "LEVEL 20";
	["SO_LEVEL_18"] = "LEVEL 21";
	["SO_LEVEL_19"] = "LEVEL 22";
	["SO_LEVEL_20"] = "LEVEL 23";
	["SO_LEVEL_21"] = "LEVEL 24";
	["SO_LEVEL_22"] = "LEVEL 25";
	["SO_LEVEL_23"] = "LEVEL 26";
	["SO_LEVEL_24"] = "LEVEL 27~";
